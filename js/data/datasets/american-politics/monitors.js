...
export const alerts = [
  ...
  },
  {
    ...
    description: 'Protesters disrupt Cities Church service targeting ICE official pastor',
  ...
  },
  {
    ...
    description: '-23% sentiment change detected following Trump shares private diplomatic messages on social media',
  ...
  },
  {
    ...
    description: "RFK Jr's meat-heavy dietary guidelines face backlash over environmental and health impacts",
  ...
  },
  {
    ...
    relatedPersonIds: [],
    relatedOrganizationIds: [],
    relatedFactionIds: ['faction-005', 'faction-006'], // Health Activists, Vegans
    relatedLocationIds: [],
    metadata: {
      factionEngagement: {
        'faction-005': 195,
  ...
  },
  {
    ...
    description: 'Indiana Judge Steven Meyer and wife shot at home',
